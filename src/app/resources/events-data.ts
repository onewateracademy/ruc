  ...
  pastEvents = [
    {
      ...
      files:[
...

        {
          ...
          url:'assets/resources/ruc_visioning_workshop/RUC Visioning Report.pdf',
          type:'pdf'
        },
        {
          name:'RUC Program',
        ...
        },
        {
          ...
          url:'assets/resources/ruc_visioning_workshop/Presentations/DASEK_ALICE_DOE.pptx',
          type:'ppt'
        },
        {
          name:"EPA's Climate Ready Water Utilities",
          url:"assets/resources/ruc_visioning_workshop/Presentations/EPA's Climate Ready Water Utilities.pdf",
          type:'pdf'
        },
        {
          name:"EPA’s Climate Ready Water Utilities:Supporting Utilities Adapting to the Impacts of Climate Change",
          url:"assets/resources/ruc_visioning_workshop/Presentations/FRIES_STEVE_EPA.pptx",
          type:'ppt'
        },
        {
          name:"HOW MIAMI-DADE IS ADAPTING AND BUILDING RESILIENCE ON MULTIPLE LEVELS THROUGH COLLABORATION",
          url:"assets/resources/ruc_visioning_workshop/Presentations/HEFTY_NICHOLE_RER.pptx",
          type:'ppt'
        },
        {
          name:"How Miami-Dade is Adapting and Building Resilience on Multiple Levels Through Collaboration",
          url:"assets/resources/ruc_visioning_workshop/Presentations/How Miami-Dade is Adapting and Building Resilience on Multiple Levels Through Collaboration.pdf",
          type:'pdf'
        },
        {
          name:"Operationalizing Resilience in Water Utilities",
          url:"assets/resources/ruc_visioning_workshop/Presentations/Operationalizing Resilience in Water Utilities.pdf",
          type:'pdf'
        },
        {
          name:"Partnering with DOE on the Water-Energy Nexus",
          url:"assets/resources/ruc_visioning_workshop/Presentations/Partnering with DOE on the Water-Energy Nexus.pdf",
          type:'pdf'
        },
        {
          name:"Resilient Utility Coalition Visioning Workshop Reporting",
          url:"assets/resources/ruc_visioning_workshop/Presentations/Resilient Utility Coalition Visioning Workshop Reporting.pdf",
          type:'pdf'
        },
        {
          name:"RUC Visioning Workshop",
          url:"assets/resources/ruc_visioning_workshop/Presentations/RUC Visioning Workshop PPT.pptx",
          type:'ppt'
        },
        {
          name:"RUC Visioning Report",
          url:"assets/resources/ruc_visioning_workshop/Presentations/RUC_VIS_RPRT.pptx",
          type:'ppt'
        },
        {
          name:"Sponsors' Logos",
          url:"assets/resources/ruc_visioning_workshop/Presentations/Sponsors_Logos_R02.pptx",
          type:'ppt'
        },
      ]
    },
    ...
    },
    {
      ...
      files:[
        ...
        {
          name:'ONE WATER ACADEMY AND RESILIENT UTILITIES COALITION Partnening Proposal',
          url:'assets/resources/tt_kick_off/ONE WATER ACADEMY AND RESILIENT UTILITIES COALITION_UPDATED Jose and Hardeep.pdf',
          type:'pdf'
        },
        {
        ...
        },
        {
          ...
          url:'assets/resources/tt_kick_off/Presentations/Enhancing Utility Resilience.pdf',
          type:'pdf'
        }
      ]
    },
    {
      ...
      files:[
        ...
        },
        {
          ...
          url:'assets/resources/tt_j100/Presentations/P. Gayle - J100 on a Budget.pptx',
          type:'ppt'
        }
      ]
    },
      ...
      files:[
        {
          ...
          url:'assets/resources/tt_security/Flyer - TT Security Starts Here.JPG',
          type:'img'
        }
